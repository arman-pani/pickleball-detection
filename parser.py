...
# parser for imgLabel
parser.add_argument('--label_video_path', type=str, default='test-video.mp4',
                    help='video path to label')
parser.add_argument('--csv_path', type=str, default='test-labels.csv',
                    help='load csv have labeled')

# parser for predict
parser.add_argument('--video_path', type=str, default='test-video.mp4',
